...
## Version 2.99 und v3 - Änderungen
...
2. Persönliche Daten
3. 7 Fragebereiche
4. Ergebnisse (Radar-Chart / Spidergraph + Zusammenfassung)
5. Prioritätsmatrix (Viererfeld) - mit Export-Buttons für beide Seiten

## Version 3 - Neue Änderungen

1. **Prädikate statt Zahlen**: Hover-Tooltip zeigt "wenig/mittel/viel" (Bedarf) und "tief/mittel/hoch" (Interesse)
2. **Sortierung verbessert**: Erst nach Prioritätsfeld, dann nach Bedarf (höher = wichtiger = tiefere Nummer)
3. **Legende vereint**: Quadranten-Beschreibung direkt in die Punkte-Legende integriert
4. **Punkt-Positionen korrigiert**: Schwellenwert auf 2 angepasst (entspricht visueller Mittellinie)
5. **Spidergraph-Hinweis**: "besser →" Beschriftung zeigt an, dass aussen = höhere Einschätzung
6. **Seiten-Reihenfolge geändert**: Radar-Chart (Spidergraph) kommt vor Viererfeld (Prioritätsmatrix)
7. **Blasseres Blau**: Buttons verwenden #60a5fa statt #2563eb
